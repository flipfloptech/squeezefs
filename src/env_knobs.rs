...
pub static KNOBS: &[Knob] = &[
    ...
    k("SQUEEZEFS_IPC_SPIN_ADAPTIVE", Kind::Bool, "off", "The spin governor arm — DEFAULT OFF (2026-08-14 adjudication: the morning static-100 bracket counted +6.7% but did not replicate across the afternoon's control band 166-189k; the governor's final guarded form counted IOPS-wash with parks -40% and clean qd1/1x32 gates). A FIELD measurement lever with live instruments (ipc_spin_{window_us,absorbed_parks,disengaged_busy}), the SQPOLL precedent."),
