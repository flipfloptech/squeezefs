...
pub static KNOBS: &[Knob] = &[
    ...
    k("SQUEEZEFS_FUSE_ZC", Kind::Bool, "off", "FUSE_URING_ZERO_COPY serve integration (K1 kill; sqz kernel + CAP_SYS_ADMIN required — declines loud elsewhere). Default OFF: the 2026-08-07 zcws-10 bracket re-adjudicated DO-NOT-FLIP on the flip rule's perf gates (rand4k 0.796x, read sentinel 33.99 < 39.5) with the wedge class closed and zero tripwires — .benchmarks/2026-08-07-zc-bridge-cqe-wedge.md."),
