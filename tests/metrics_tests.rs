...
async fn fuse_zc_ledger_always_exports_under_metrics() {
    ...
    let zc_family = [
        ...
        "fuse3_zc_write_fusions",
        "fuse3_zc_write_fusion_bytes",
        "fuse3_zc_write_fusion_demotions",
        "fuse3_zc_write_lazy_extractions",
        "fuse3_zc_write_placements",
        "fuse3_zc_write_placement_bytes",
        "fuse3_zc_write_place_fallbacks",
