...
| Document | Contents |
|---|---|
| [RELEASE_NOTES.md](RELEASE_NOTES.md) | What changed in 1.2.2, 1.2.1 and 1.2.0: highlights, upgrading from 1.1, fixes, new operator surface, known limitations, the release gate |
